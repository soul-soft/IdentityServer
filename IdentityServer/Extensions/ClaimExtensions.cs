...
namespace IdentityServer.Extensions
{
    public static class ClaimExtensions
    {
        ...
        public static string? GetSubjectId(this ClaimsIdentity identity)
        {
            var claim = identity.FindFirst(JwtClaimTypes.Subject);
            return claim?.Value;
        }

        public static string? GetIdentityProvider(this ClaimsIdentity identity)
        {
            var claim = identity.FindFirst(JwtClaimTypes.IdentityProvider);
            return claim?.Value;
        }
